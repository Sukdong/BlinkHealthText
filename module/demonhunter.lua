...
if GetLocale()=="koKR" then
	...
	L_USE_DEMONHUNTER_ACTIVATED_SPELL = "전문화별 발동 효과 발동시 아이콘을 표시합니다."
end
...
function module:init()
	...
	if not config_added then
		...
		self:AddMiscConfig{
			type = "toggle",
			text = L_USE_DEMONHUNTER_ACTIVATED_SPELL,
			tooltip = L_USE_DEMONHUNTER_ACTIVATED_SPELL,
			get = function ()
